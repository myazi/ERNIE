...
DATA_PATH=table_bkv_data_round1
#MODEL_PATH="ernie_base_twin_CN/params"
MODEL_PATH=./checkpoint/baike_twin_round1_7384
#MODEL_PATH=durd_twin_round1_9838
#MODEL_PATH=step_20538
...
/root/anaconda3/envs/paddle_116/bin/python ./ernie/run_classifier_recall.py \
                   ...
                   --train_set ./data/tbkv_twin_round1.joint_2pos_4neg_tag_1W \
                   --dev_set ${DATA_PATH}/top1_twin_test.top50 \
                   --test_set ${DATA_PATH}/tbkv_twin_test.top50_1K \
