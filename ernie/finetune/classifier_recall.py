...
def create_model(args,
    ...
    #print(batch_size)
    #print(args.q_max_seq_len)
    #print(args.p_max_seq_len)
    ...
    q_cls_feats = ernie_q.get_pooled_output_recall("query_")
    pos_cls_feats = ernie_pos.get_pooled_output_recall("titlepara_")
    neg_cls_feats = ernie_neg.get_pooled_output_recall("titlepara_")
#    q_cls_feats.stop_gradient = True
    ...
    probs = logits
    #fluid.layers.Print(logits, message='logits')
